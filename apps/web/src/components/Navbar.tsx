...
import { Menu, X, ArrowRight, Languages, ChevronDown, Moon, Sun } from 'lucide-react';
                            ...
                            <Magnetic key={link.id} strength={0.3}>
                                ...
                                >
                                    ...
                                    {activeTab === link.id && (
                                        <motion.div
                                            layoutId="activeTab"
                                            className="absolute inset-0 bg-academy-navy dark:bg-academy-orange shadow-lg"
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -20 }}
                        className="md:hidden fixed inset-x-4 top-24 bg-white/95 dark:bg-academy-deepNavy/95 backdrop-blur-3xl rounded-[3rem] shadow-2xl border border-white dark:border-white/10 p-8 z-[120]"
                    >
                        <div className="space-y-4">
                            {navLinks.map((link) => (
                                <button
                                    ...
                                    className={`block w-full text-left px-6 py-4 rounded-3xl text-xl font-serif font-black transition-all ${activeTab === link.id ? 'bg-academy-navy dark:bg-academy-orange text-white' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/5'
                                        }`}
                                >
                                    {link.name}
                                </button>
